...
**Documentation (German)**  | https://docs.goobi.io/de/workflow/plugins/workflow/goobi-plugin-workflow-project-export
**Documentation (English)** | https://docs.goobi.io/en/workflow/plugins/workflow/goobi-plugin-workflow-project-export
